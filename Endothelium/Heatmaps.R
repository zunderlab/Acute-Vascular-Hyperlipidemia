...
FONTSIZE_CLUSTERING <- 24 #base fontsize for plot showing clustering vars
...
CLUSTER_REORDER <- c(2,5,6,4,8,1,7,3)
...
png("Heatmap_clustering.png",width = 1162,height = 664)
...
# png("Heatmap_plotting.png",
#     #width = 1162/2,height = 664/2
#     )
