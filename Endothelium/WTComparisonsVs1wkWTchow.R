...
heatmap.2(plotting_vals,Colv = FALSE,distfun = custom_dist,col = color_heat,breaks = col_breaks,key = FALSE,trace = "none",,lhei = c(1,10),lwid = c(1,10),cexRow = 1,cexCol = 1)
dev.off()
